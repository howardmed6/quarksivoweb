...
{ id: 201, title: 'JPG a PDF', icon: '📄', route: '/image/jpg-to-pdf', category: 'images' },
{ id: 202, title: 'PNG a PDF', icon: '📄', route: '/image/png-to-pdf', category: 'images' },
{ id: 203, title: 'AVIF a PDF', icon: '📄', route: '/image/avif-to-pdf', category: 'images' },
{ id: 204, title: 'BMP a PDF', icon: '📄', route: '/image/bmp-to-pdf', category: 'images' },
{ id: 205, title: 'WebP a PDF', icon: '📄', route: '/image/webp-to-pdf', category: 'images' },
{ id: 206, title: 'HEIC a PDF', icon: '📄', route: '/image/heic-to-pdf', category: 'images' },
{ id: 207, title: 'GIF a PDF', icon: '📄', route: '/image/gif-to-pdf', category: 'images' },
{ id: 208, title: 'TIFF a PDF', icon: '📄', route: '/image/tiff-to-pdf', category: 'images' },
{ id: 209, title: 'SVG a PDF', icon: '📄', route: '/image/svg-to-pdf', category: 'images' },
{ id: 210, title: 'ICO a PDF', icon: '📄', route: '/image/ico-to-pdf', category: 'images' },
//   // 🎬 Videos (IDs 262-264)
