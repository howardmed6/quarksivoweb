...
export const CONTACT_INFO = {
  schedule: "Lun-Vie: 9 AM — 5 PM COT",
  email: "servicio@quarkivo.com",
  phoneCol: "+57-301-234-5678",
  phoneUSA: "+1-888-291-0471"
};

export const FOOTER_LINKS = {
  info: [
    { text: "Centro de Ayuda", href: "#ayuda" },
    { text: "Devoluciones e Intercambios", href: "#devoluciones" },
    { text: "Política de Privacidad", href: "#privacidad" },
    { text: "Accesibilidad", href: "#accesibilidad" }
  ],
  partners: [
    { text: "Aplicación Mayoristas", href: "#mayoristas" },
    { text: "Login Mayoristas", href: "#login-mayoristas" },
    { text: "Descuento Comunidad", href: "#descuento-comunidad" },
    { text: "Programa de Afiliados", href: "#afiliados" },
    { text: "Panel de Embajadores", href: "#embajadores" }
  ]
};
